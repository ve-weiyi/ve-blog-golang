...
type (
	...
	TVisitLogModel interface {
		...
		// 查询
		FindOne(ctx context.Context, id int64) (out *TVisitLog, err error)
		FindALL(ctx context.Context, conditions string, args ...interface{}) (list []*TVisitLog, err error)
		FindList(ctx context.Context, page int, size int, sorts string, conditions string, args ...interface{}) (list []*TVisitLog, err error)
...
func NewTVisitLogModel(db *gorm.DB, cache *redis.Client) TVisitLogModel {
...
func (m *defaultTVisitLogModel) WithTransaction(tx *gorm.DB) (out TVisitLogModel) {
	return NewTVisitLogModel(tx, m.CacheEngin)
}
...
// 查询记录
func (m *defaultTVisitLogModel) FindOne(ctx context.Context, id int64) (out *TVisitLog, err error) {
	db := m.DbEngin.WithContext(ctx).Table(m.table)
...
// 分页查询记录
func (m *defaultTVisitLogModel) FindList(ctx context.Context, page int, size int, sorts string, conditions string, args ...interface{}) (list []*TVisitLog, err error) {
	// 插入db
	db := m.DbEngin.WithContext(ctx).Table(m.table)
