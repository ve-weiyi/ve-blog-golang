...
// 创建聊天记录
func (l *AddChatLogic) AddChat(in *newsrpc.AddChatReq) (*newsrpc.AddChatResp, error) {
	entity := &model.TChat{
		Id:         0,
		UserId:     in.UserId,
	...
	return &newsrpc.AddChatResp{
		Chat: convertChatOut(entity),
	}, nil
}

func convertChatOut(in *model.TChat) (out *newsrpc.Chat) {
	out = &newsrpc.Chat{
		Id:         in.Id,
		UserId:     in.UserId,
		TerminalId: in.TerminalId,
