...
type (
	...
	TRoleApiModel interface {
		TableName() string
		// 在事务中操作
		WithTx(tx *gorm.DB) (out TRoleApiModel)
		// 插入
		Insert(ctx context.Context, in *TRoleApi) (rows int64, err error)
		InsertBatch(ctx context.Context, in ...*TRoleApi) (rows int64, err error)
		// 删除
		...
		FindOne(ctx context.Context, sorts string, conditions string, args ...interface{}) (out *TRoleApi, err error)
	...
	TRoleApi struct {
		...
		RoleId int64 `gorm:"column:role_id;type:bigint;not null;default:0;comment:角色id" json:"role_id"`  // 角色id
		ApiId  int64 `gorm:"column:api_id;type:bigint;not null;default:0;comment:接口id" json:"api_id"`    // 接口id
	}
...
// 在事务中操作
func (m *defaultTRoleApiModel) WithTx(tx *gorm.DB) (out TRoleApiModel) {
	return NewTRoleApiModel(tx)
}
...
// 插入记录（批量操作）
func (m *defaultTRoleApiModel) InsertBatch(ctx context.Context, in ...*TRoleApi) (rows int64, err error) {
	db := m.DbEngin.WithContext(ctx).Table(m.table)
...
// 删除记录（批量操作）
func (m *defaultTRoleApiModel) DeleteBatch(ctx context.Context, conditions string, args ...interface{}) (rows int64, err error) {
	db := m.DbEngin.WithContext(ctx).Table(m.table)
...
// 更新记录（批量操作）
func (m *defaultTRoleApiModel) UpdateFields(ctx context.Context, feilds map[string]interface{}, conditions string, args ...interface{}) (rows int64, err error) {
	db := m.DbEngin.WithContext(ctx).Table(m.table)
...
// 查询记录
func (m *defaultTRoleApiModel) FindById(ctx context.Context, id int64) (out *TRoleApi, err error) {
	db := m.DbEngin.WithContext(ctx).Table(m.table)
...
// 查询记录
func (m *defaultTRoleApiModel) FindOne(ctx context.Context, sorts string, conditions string, args ...interface{}) (out *TRoleApi, err error) {
	db := m.DbEngin.WithContext(ctx).Table(m.table)
...
// 分页查询记录
func (m *defaultTRoleApiModel) FindListAndTotal(ctx context.Context, page int, size int, sorts string, conditions string, args ...interface{}) (list []*TRoleApi, total int64, err error) {
	// 插入db
	db := m.DbEngin.WithContext(ctx).Table(m.table)
