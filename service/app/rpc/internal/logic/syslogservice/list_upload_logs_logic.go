...
type ListUploadLogsLogic struct {
	ctx    context.Context
	svcCtx *svc.ServiceContext
	logx.Logger
}

func NewListUploadLogsLogic(ctx context.Context, svcCtx *svc.ServiceContext) *ListUploadLogsLogic {
	return &ListUploadLogsLogic{
		ctx:    ctx,
		svcCtx: svcCtx,
