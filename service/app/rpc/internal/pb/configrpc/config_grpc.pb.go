...
const (
	ConfigService_GetConfig_FullMethodName  = "/configrpc.ConfigService/GetConfig"
	ConfigService_SaveConfig_FullMethodName = "/configrpc.ConfigService/SaveConfig"
)
...
func (c *configServiceClient) SaveConfig(ctx context.Context, in *SaveConfigRequest, opts ...grpc.CallOption) (*SaveConfigResponse, error) {
	...
	err := c.cc.Invoke(ctx, ConfigService_SaveConfig_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var ConfigService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "configrpc.ConfigService",
