...
func (l *DeleteTalkLogic) DeleteTalk(req *types.DeleteTalkReq) (resp *types.BatchResp, err error) {
	out, err := l.svcCtx.SocialService.DeleteTalk(l.ctx, &socialservice.DeleteTalkRequest{
		Ids: req.Ids,
	})
	if err != nil {
		return nil, err
