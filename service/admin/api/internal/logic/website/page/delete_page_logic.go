...
func (l *DeletePageLogic) DeletePage(req *types.DeletePageReq) (resp *types.BatchResp, err error) {
	out, err := l.svcCtx.ResourceService.DeletePage(l.ctx, &resourceservice.DeletePageRequest{
		Ids: req.Ids,
	})
	if err != nil {
		return nil, err
