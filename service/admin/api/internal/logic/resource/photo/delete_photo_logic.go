...
func (l *DeletePhotoLogic) DeletePhoto(req *types.DeletePhotoReq) (resp *types.BatchResp, err error) {
	out, err := l.svcCtx.ResourceService.DeletePhoto(l.ctx, &resourceservice.DeletePhotoRequest{
		Ids: req.Ids,
	})
	if err != nil {
		return nil, err
