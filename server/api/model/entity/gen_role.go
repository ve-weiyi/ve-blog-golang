...
type Role struct {
	...
	IsDisable   bool      `gorm:"column:is_disable;type:tinyint(1);not null;comment:是否禁用  0否 1是" json:"is_disable"`                  // 是否禁用  0否 1是
	IsDefault   bool      `gorm:"column:is_default;type:tinyint(1);not null;comment:是否默认角色 0否 1是" json:"is_default"`                 // 是否默认角色 0否 1是
