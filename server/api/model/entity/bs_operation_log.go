...
type OperationLog struct {
	...
	OptModule      string    `gorm:"column:opt_module;type:varchar(20);comment:操作模块" json:"opt_module"`                                 // 操作模块
	...
	RequestMethod  string    `gorm:"column:request_method;type:varchar(20);comment:请求方式" json:"request_method"`                         // 请求方式
	...
	ResponseStatus int       `gorm:"column:response_status;type:int;comment:响应状态码" json:"response_status"`                              // 响应状态码
