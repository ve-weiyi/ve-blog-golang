...
// 分页获取Tag记录
func (l *TagService) FindTagList(reqCtx *request.Context, page *dto.PageQuery) (list []*entity.Tag, total int64, err error) {
	p, s := page.PageClause()
	cond, args := page.ConditionClause()
	order := page.OrderClause()

	list, err = l.svcCtx.TagRepository.FindList(reqCtx, p, s, order, cond, args...)
	if err != nil {
		return nil, 0, err
	}
