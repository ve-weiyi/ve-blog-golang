...
// 分页查询RoleApi记录
func (s *RoleApiRepository) FindRoleApiList(ctx context.Context, page *request.PageQuery, conditions ...*request.Condition) (list []*entity.RoleApi, total int64, err error) {
	// 创建db
	db := s.DbEngin.WithContext(ctx)
