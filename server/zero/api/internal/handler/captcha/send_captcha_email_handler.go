...
func SendCaptchaEmailHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := captcha.NewSendCaptchaEmailLogic(r.Context(), svcCtx)
		resp, err := l.SendCaptchaEmail(&req)
