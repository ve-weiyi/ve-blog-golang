...
func FindTagDetailsListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := tag.NewFindTagDetailsListLogic(r.Context(), svcCtx)
		resp, err := l.FindTagDetailsList(&req)
