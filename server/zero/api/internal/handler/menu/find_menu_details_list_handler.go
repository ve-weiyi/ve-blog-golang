...
func FindMenuDetailsListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := menu.NewFindMenuDetailsListLogic(r.Context(), svcCtx)
		resp, err := l.FindMenuDetailsList(&req)
