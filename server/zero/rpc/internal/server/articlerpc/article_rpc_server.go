...
import (
	...
	"github.com/ve-weiyi/ve-blog-golang/server/zero/rpc/internal/logic/articlerpc"
...
func (s *ArticleRpcServer) DeleteArticle(ctx context.Context, in *blog.IdReq) (*blog.EmptyResp, error) {
...
func (s *ArticleRpcServer) DeleteArticleList(ctx context.Context, in *blog.IdsReq) (*blog.BatchResult, error) {
	l := articlerpclogic.NewDeleteArticleListLogic(ctx, s.svcCtx)
	return l.DeleteArticleList(in)
}

func (s *ArticleRpcServer) FindArticleList(ctx context.Context, in *blog.PageQuery) (*blog.PageResult, error) {
