...
type (
	...
	Route struct {
		...
		Method             string
		Path               string
		PathType           []Member `json:",omitempty"`
		HeaderType         []Member `json:",omitempty"`
		FormType           []Member `json:",omitempty"`
		QueryType          []Member `json:",omitempty"`
		RequestType        Type     `json:",omitempty"`
		ResponseType       Type     `json:",omitempty"`
		Docs               Doc
		Handler            string
		AtDoc              AtDoc
		HandlerDoc         Doc
