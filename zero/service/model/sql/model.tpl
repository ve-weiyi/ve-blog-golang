...
var _ {{.upperStartCamelObject}}Model = (*default{{.upperStartCamelObject}}Model)(nil)
...
type (
	...
	{{.upperStartCamelObject}}Model interface {
		...
		// 插入
		Insert(ctx context.Context, in *{{.upperStartCamelObject}}) (rows int64, err error)
		InsertBatch(ctx context.Context, in ...*{{.upperStartCamelObject}}) (rows int64, err error)
		// 更新
		Update(ctx context.Context, in *{{.upperStartCamelObject}}) (rows int64, err error)
        Save(ctx context.Context, in *{{.upperStartCamelObject}}) (rows int64, err error)
        // 删除
		Delete(ctx context.Context, id int64) (rows int64, err error)
		DeleteBatch(ctx context.Context, conditions string, args ...interface{}) (rows int64, err error)
		// 查询
		FindOne(ctx context.Context, id int64) (out *{{.upperStartCamelObject}}, err error)
		First(ctx context.Context, conditions string, args ...interface{}) (out *{{.upperStartCamelObject}}, err error)
		FindCount(ctx context.Context, conditions string, args ...interface{}) (count int64, err error)
		FindALL(ctx context.Context, conditions string, args ...interface{}) (list []*{{.upperStartCamelObject}}, err error)
		FindList(ctx context.Context, page int, size int, sorts string, conditions string, args ...interface{}) (list []*{{.upperStartCamelObject}}, err error)
	    // add extra method in here
        {{- range $key, $value := .uniqueFields}}
            FindOneBy{{ funcFieldsKey $value}}(ctx context.Context, {{funcFieldsKeyVar $value}}) (out *{{$.upperStartCamelObject}},err error)
        {{- end}}
	}
...
func New{{.upperStartCamelObject}}Model(db *gorm.DB, cache *redis.Client) {{.upperStartCamelObject}}Model {
...
func (m *default{{.upperStartCamelObject}}Model) Insert(ctx context.Context, in *{{.upperStartCamelObject}}) (rows int64, err error) {
...
// 更新记录（不更新零值）
func (m *default{{.upperStartCamelObject}}Model) Update(ctx context.Context, in *{{.upperStartCamelObject}}) (rows int64, err error) {
	db := m.DbEngin.WithContext(ctx).Table(m.table)
...
// 更新记录（更新零值）
func (m *default{{.upperStartCamelObject}}Model) Save(ctx context.Context, in *{{.upperStartCamelObject}}) (rows int64, err error) {
	db := m.DbEngin.WithContext(ctx).Table(m.table)
...
// 分页查询记录
func (m *default{{.upperStartCamelObject}}Model) FindList(ctx context.Context, page int, size int, sorts string, conditions string, args ...interface{}) (list []*{{.upperStartCamelObject}}, err error) {
	// 插入db
	db := m.DbEngin.WithContext(ctx).Table(m.table)
...
// add extra method in here
{{- range $key, $value := .uniqueFields}}
func (m *default{{$.upperStartCamelObject}}Model) FindOneBy{{ funcFieldsKey $value}}(ctx context.Context, {{funcFieldsKeyVar $value}}) (out *{{$.upperStartCamelObject}},err error) {
	db := m.DbEngin.WithContext(ctx).Table(m.table)
