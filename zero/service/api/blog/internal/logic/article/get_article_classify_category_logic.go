...
type GetArticleClassifyCategoryLogic struct {
	logx.Logger
	ctx    context.Context
...
// 通过标签或者id获取文章列表
func NewGetArticleClassifyCategoryLogic(ctx context.Context, svcCtx *svc.ServiceContext) *GetArticleClassifyCategoryLogic {
	return &GetArticleClassifyCategoryLogic{
...
func (l *GetArticleClassifyCategoryLogic) GetArticleClassifyCategory(req *types.ArticleClassifyReq) (resp *types.ArticleClassifyResp, err error) {
