...
// 上传文件
func (m *defaultBlogRpc) GetUserVisitList(ctx context.Context, in *EmptyReq, opts ...grpc.CallOption) (*UserVisitPageRsp, error) {
	client := blog.NewBlogRpcClient(m.cli.Conn())
	return client.GetUserVisitList(ctx, in, opts...)
}
