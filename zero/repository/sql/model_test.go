...
func TestParseSql(t *testing.T) {
	tables, err := parser.Parse(filepath.Join(global.GetCurrentDir(), "../../../server/test.sql"), "go_zero", false)
	...
	for _, table := range tables {
		...
		if table.Name.Source() == "user_account" || table.Name.Source() == "user_information" {
			continue
		}
