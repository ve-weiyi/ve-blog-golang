...
// LoadConfigOption 加载配置选项（用于初始化时传递参数）
...
func LoadConfig(option *LoadConfigOption) (*config.Config, error) {
...
func initLocalConfig(option *LoadConfigOption) (*config.Config, error) {
...
func initNacosConfig(option *LoadConfigOption) (*config.Config, error) {
