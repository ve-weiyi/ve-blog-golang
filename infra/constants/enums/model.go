...
const (
	...
	UserStatusLogoff   = 2  // 注销
)

// 登录日志 (t_login_log)
const (
	// 登录类型
	LoginTypeRegister = "register" // 用户注册
	LoginTypeUsername = "username" // 用户名登录
	LoginTypeEmail    = "email"    // 邮箱登录
	LoginTypeMobile   = "mobile"   // 手机登录
...
const (
	CodeSceneMobileLogin  = "mobile_login"
	CodeSceneEmailLogin   = "email_login"
	CodeSceneRegister     = "register"
	CodeSceneRestPassword = "reset_password"
	CodeSceneBind         = "bind"
)
